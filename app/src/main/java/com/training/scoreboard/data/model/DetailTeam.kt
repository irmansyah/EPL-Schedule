package com.training.scoreboard.data.model

import com.google.gson.annotations.Expose
import com.google.gson.annotations.SerializedName

data class DetailTeamResponse(@SerializedName("teams")
                         @Expose
                         var teams: List<DetailTeam>? = null)

data class DetailTeam(@SerializedName("idTeam")
           @Expose
